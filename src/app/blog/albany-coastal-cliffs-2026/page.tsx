...
export const metadata: Metadata = {
  title: "Albany Coastal Cliffs: WA's Most Dramatic Road Trip Viewpoints 2026 | AutoTrip Perth",
  description: "Forget Margaret River for a minute. Albany's coastal cliffs are WA's best-kept secret. Here's how to do the perfect Great Southern road trip from Perth, with local tips on where to stop, what to see, and why you'll need a proper car for this adventure.",
      ...
      <div className="container mx-auto px-6 lg:px-8 max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-slate-900 mb-4 leading-tight">
            Albany's Coastal Cliffs: Why This is WA's Best Road Trip (And Everyone's Missing It)
          </h1>
        ...
        <div className="relative w-full aspect-[16/9] rounded-3xl overflow-hidden mb-12">
          <Image
            ...
            alt="Local sitting on The Gap cliffs in Albany, WA — this is what you're driving 4.5 hours from Perth to see"
            fill
          ...
          <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur px-4 py-2 rounded-lg">
            <p className="text-sm font-medium text-slate-900">The Gap, Albany — worth every kilometre of the drive from Perth</p>
          </div>
        </div>
        ...
        <article className="prose prose-lg prose-slate max-w-none">
          ...
          <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">The Perfect 3-Day Albany Road Trip (Local's Version)</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 my-8">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6">
              ...
              <p className="text-slate-600 text-sm">Morning at The Gap & Natural Bridge, lunch at Albany's London Hotel (oldest continuously licensed hotel in WA), afternoon at Misery Beach, finish with a wine tasting at a Denmark cellar door.</p>
            </div>
            <div className="bg-white border border-slate-200 rounded-2xl p-6">
          ...
          <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">What You Need to Know About Renting a Car for Albany</h2>
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3">
              ...
              <span><strong>Book your car like you book accommodation:</strong> Albany weekends book out weeks in advance. Reserve your AutoTrip vehicle at least 2-3 weeks ahead, especially for school holidays.</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="bg-primary/10 text-primary rounded-full p-1 mt-1">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-3xl p-8 my-12 text-center">
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Ready to Actually See Albany?</h3>
            ...
            <Link href="/" className="inline-flex items-center gap-2 bg-primary text-white px-6 py-3 rounded-full font-bold hover:bg-slate-900 transition">
              Book Your Albany Road Trip Car (The Right Way)
